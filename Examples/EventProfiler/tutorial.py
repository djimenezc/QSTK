...
eventMatrix = findEvents(symbols, startday, endday, marketSymbol='SPY',
                         verbose=True)
...
eventProfiler.study(filename="MyEventStudy.pdf", plotErrorBars=True,
                    plotMarketNeutral=True, plotEvents=False,
                    marketSymbol='SPY')
